...
const {log, LogLevel, asyncForEach} = require(path.resolve(__dirname, 'helper.migration.js'));
...
const fullTestForReleaseStrategies = require(path.resolve(__dirname, `ch.mobiliar.${projectId}`));
    ...
    asyncForEach(fullTestForReleaseStrategies.strategies, (strategy, strategyIndex) => {
        ...
        switch (mode) {
            case 'SINGLE':
                ...
                params = ['./config/strategies.release/wdio.conf.release.js', '--deviceInfo', configFilePath];
                singleDevice = {
                    ...singleDevice,
                    ...strategy,
                    ...signingIdentity
