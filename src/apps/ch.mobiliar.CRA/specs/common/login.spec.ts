...
import {expectedOverviewScreenTitle, OverviewScreen} from '../../screens/objects/overview.screen.actions';
...
xdescribe('Login Screen', () => {
    ...
    it('HAN-663: should allow user to dismiss login modal and see overview screen', () => {
        ...
        expect(overviewScreen.getOverviewScreenTitle()).toEqual(expectedOverviewScreenTitle);
    });
